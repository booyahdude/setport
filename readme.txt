...
1. Run the following command in a terminal: "sudo ln -s <path to setport>/setport /usr/local/bin/" where <path to setport>
is the local path to the executable on your system.

*Note that you will need sudo priviledges to do this.
...
PREREQUISITES: You must have errArg.txt, errPort.txt, success.txt, success2.txt, successES.txt, successPL.txt, about.txt,
